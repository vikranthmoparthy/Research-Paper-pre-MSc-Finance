...
DESCRIPTION: 
Combines separate payment rows and filters the data to keep only domestic US deals.
...
#Use Day -50 Market Cap for the control variable
final_regression_dataset['Log_Acq_Size'] = np.log(final_regression_dataset['DlyCap_Minus_50'])
